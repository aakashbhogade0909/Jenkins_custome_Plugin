...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/etc/maven/nexus-metadata-plugin");
    parameters.put("artifactId","nexus-metadata-plugin");
    parameters.put("outputDirectory","/etc/maven/nexus-metadata-plugin/target/classes");
    parameters.put("testOutputDirectory","/etc/maven/nexus-metadata-plugin/target/test-classes");
